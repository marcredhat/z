...
/etc/hosts on laptop:
127.0.0.1   localhost ... oauth-openshift.apps.ocp45.local console-openshift-console.apps.ocp45.local console-openshift-console.apps.ocp4.local oauth-openshift.apps.ocp45.local
