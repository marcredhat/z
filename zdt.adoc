...
**  Make it really easy to deploy and test Ansible/Z, Cloud Broker etc with various OpenShift 4 releases. **
...
** Enable CI/CD scenarios with frontends running on OpenShift and backend running on mainframes.


** Overcome limitations of existing zTrial environments ** e.g.
...
**  Allow full flexibility to test various mainframe component/subsystem versions:
----
