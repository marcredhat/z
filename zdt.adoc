...
yum -y install zip bind-utils wget tar gcc python3-devel python3  libguestfs-tools-c tmux httpd-tools git nc net-tools
----
...
./ZDT_Install_EE_V12.0.5.0.x86_64 --install --zdtswlicense --ackVM --dep 

./ZDT_Install_EE_V12.0.5.0.x86_64 --install --zdtswlicense --ackVM 
----
