...
----
1) Make it really easy to deploy and test Ansible/Z, Cloud Broker etc 
with various OpenShift 4 releases.
...
2) Enable CI/CD scenarios with 
frontends running on OpenShift and 
backend running on mainframes.
...
3) Allow full flexibility to test various mainframe component/subsystem versions:
